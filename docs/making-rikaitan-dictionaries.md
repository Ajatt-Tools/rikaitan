...
"json.schemas": [
    {
        ...
        "url": "https://raw.githubusercontent.com/Ajatt-Tools/rikaitan/refs/heads/master/ext/data/schemas/dictionary-index-schema.json"
    },
    {
        "fileMatch": ["kanji_bank_*.json"],
        "url": "https://raw.githubusercontent.com/Ajatt-Tools/rikaitan/refs/heads/master/ext/data/schemas/dictionary-kanji-bank-v3-schema.json"
    },
    {
        "fileMatch": ["kanji_meta_bank_*.json"],
        "url": "https://raw.githubusercontent.com/Ajatt-Tools/rikaitan/refs/heads/master/ext/data/schemas/dictionary-kanji-meta-bank-v3-schema.json"
    },
    {
        "fileMatch": ["tag_bank_*.json"],
        "url": "https://raw.githubusercontent.com/Ajatt-Tools/rikaitan/refs/heads/master/ext/data/schemas/dictionary-tag-bank-v3-schema.json"
    },
    {
        "fileMatch": ["term_bank_*.json"],
        "url": "https://raw.githubusercontent.com/Ajatt-Tools/rikaitan/refs/heads/master/ext/data/schemas/dictionary-term-bank-v3-schema.json"
    },
    {
        "fileMatch": ["term_meta_bank_*.json"],
        "url": "https://raw.githubusercontent.com/Ajatt-Tools/rikaitan/refs/heads/master/ext/data/schemas/dictionary-term-meta-bank-v3-schema.json"
    }
]
```
