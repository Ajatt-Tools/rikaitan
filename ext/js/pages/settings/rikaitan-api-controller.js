...
export class RikaitanApiController {
    /**
    ...
    constructor(api) {
        ...
        this._testButton = querySelectorNotNull(document, '#test-rikaitan-api-button');
        /** @type {HTMLElement} */
        this._resultsContainer = querySelectorNotNull(document, '#test-rikaitan-api-results');
        /** @type {HTMLInputElement} */
        this._urlInput = querySelectorNotNull(document, '#test-rikaitan-url-input');
        /** @type {boolean} */
    ...
    _onTestButtonClick(e) {
        e.preventDefault();
        void this._testRikaitanApi();
    }

    /** */
    async _testRikaitanApi() {
        ...
        try {
            ...
            await this._api.testRikaitanApi(this._urlInput.value);
