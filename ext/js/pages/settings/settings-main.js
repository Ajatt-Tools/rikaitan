...
import {RikaitanApiController} from './rikaitan-api-controller.js';
...
await Application.main(true, async (application) => {
    ...
    const rikaitanApiController = new RikaitanApiController(application.api);
    rikaitanApiController.prepare();
