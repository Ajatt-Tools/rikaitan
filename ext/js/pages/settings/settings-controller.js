...
export class SettingsController extends EventDispatcher {
    ...
    async getOptions() {
        ...
        return await rikaitan.api.optionsGet(optionsContext);
    }
    ...
    async getOptionsFull() {
        return await rikaitan.api.optionsGetFull();
    }
    ...
    async setAllSettings(value) {
        ...
        await rikaitan.api.setAllSettings(value, this._source);
    ...
    async getDictionaryInfo() {
        return await rikaitan.api.getDictionaryInfo();
    }
    ...
    async _getSettings(targets, extraFields) {
        ...
        return await rikaitan.api.getSettings(targets2);
    }
    ...
    async _modifySettings(targets, extraFields) {
        ...
        return await rikaitan.api.modifySettings(targets2, this._source);
    }
