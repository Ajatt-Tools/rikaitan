...
export class DictionaryImporter {
    ...
    async importDictionary(dictionaryDatabase, archiveContent, details) {
        ...
        let summaryDetails = {prefixWildcardsSupported, counts, styles: '', rikaitanVersion, importSuccess};
        ...
        summaryDetails = {prefixWildcardsSupported, counts, styles, rikaitanVersion, importSuccess};
