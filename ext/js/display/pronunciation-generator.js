...
export class PronunciationGenerator {
    ...
    // The following Jimanjisho pitch graph code is based on code from
    // https://github.com/aporrllli/jimanjisho licensed under the
    // GNU General Public License v3.0

    /**
     * Create a pronounciation graph in the style of Jimanjisho
     * @param {string[]} mora
     * @param {number | string} pitchPositions
     * @returns {SVGSVGElement}
     */
