...
export class Popup extends EventDispatcher {
    ...
    constructor({
        ...
        this._frame.className = 'rikaitan-popup';
    ...
    async setCustomOuterCss(css, useWebExtensionApi) {
        ...
        const node = await loadStyle('rikaitan-popup-outer-user-stylesheet', 'code', css, useWebExtensionApi, parentNode);
    ...
    async _injectPopupOuterStylesheet() {
        ...
        await loadStyle('rikaitan-popup-outer-stylesheet', fileType, '/css/popup-outer.css', useWebExtensionApi, parentNode);
    }
    ...
    async _invoke(action, params) {
        ...
        return await rikaitan.crossFrame.invoke(this._frameClient.frameId, 'popupMessage', message);
    }
