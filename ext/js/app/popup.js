...
export class Popup extends EventDispatcher {
    ...
    async setCustomOuterCss(css, useWebExtensionApi) {
        ...
        const node = await loadStyle(this._application, 'rikaitan-popup-outer-user-stylesheet', 'code', css, useWebExtensionApi, parentNode);
    ...
    async _injectPopupOuterStylesheet() {
        ...
        await loadStyle(this._application, 'rikaitan-popup-outer-stylesheet', fileType, '/css/popup-outer.css', useWebExtensionApi, parentNode);
    }
