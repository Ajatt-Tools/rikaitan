...
export class API {
    /**
     * @param {import('../rikaitan.js').Rikaitan} rikaitan
     */
    constructor(rikaitan) {
        /** @type {import('../rikaitan.js').Rikaitan} */
        this._rikaitan = rikaitan;
    }
    ...
    _invoke(action, params) {
        ...
        return new Promise((resolve, reject) => {
            try {
                this._rikaitan.sendMessage(data, (response) => {
