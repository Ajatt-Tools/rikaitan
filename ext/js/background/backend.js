...
export class Backend {
    ...
    async _injectAnkiNoteAudio(ankiConnect, timestamp, definitionDetails, details) {
        ...
        let fileName = this._generateAnkiNoteMediaFileName('rikaitan_audio', extension, timestamp, definitionDetails);
    ...
    async _injectAnkiNoteScreenshot(ankiConnect, timestamp, definitionDetails, details) {
        ...
        const fileName = this._generateAnkiNoteMediaFileName('rikaitan_browser_screenshot', extension, timestamp, definitionDetails);
        return await ankiConnect.storeMediaFile(fileName, data);
    }
    ...
    async _injectAnkiNoteClipboardImage(ankiConnect, timestamp, definitionDetails) {
        ...
        const fileName = this._generateAnkiNoteMediaFileName('rikaitan_clipboard_image', extension, timestamp, definitionDetails);
        return await ankiConnect.storeMediaFile(fileName, data);
    }
